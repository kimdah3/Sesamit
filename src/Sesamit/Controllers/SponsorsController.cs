...
namespace Sesamit.Controllers
{
    ...
    public class SponsorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EndDate,Name,Picture,StartDate")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EndDate,Name,Picture,StartDate")] Sponsor sponsor)
        {
            if (id != sponsor.Id)
            {
                return NotFound();
